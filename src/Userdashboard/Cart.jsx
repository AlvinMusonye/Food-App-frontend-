  ...
  return (
    <div className="dark:bg-dark-contrast">
      <div className="max-w-2xl h-screen mx-auto p-6">
        <h1 className="text-3xl font-bold mb-6 text-center dark:text-orange-500">🛒 Your Cart</h1>
        ...
        {cart.length === 0 ? (
          ...
          <div className="border p-4 rounded-lg shadow-lg">
            {cart.map((item) => (
              <div key={item.id} className="flex justify-between items-center mb-2 dark:text-gray-100">
                <p>
