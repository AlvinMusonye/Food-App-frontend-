  ...
  return (
    ...
    <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
        <div className="bg-white shadow-md rounded-lg p-4 flex flex-col items-center">
            <img src="/public/assets/Martha's Country Bakery (@marthascountrybakery) •….jpeg" alt="Burger" className="w-48 h-48 object-cover rounded-md" />
        ...
        <div className="bg-white shadow-md rounded-lg p-4 flex flex-col items-center">
            <img src="/public/assets/Chocolate Glazed Donuts by Master Baker - My Urban Treats.jpeg" alt="KFC" className="w-48 h-48 object-cover rounded-md" />
        ...
        <div className="bg-white shadow-md rounded-lg p-4 flex flex-col items-center">
            <img src="/public/assets/Mixed Berry Tart Recipe _ Driscoll's.jpeg" alt="Pizza" className="w-48 h-48 object-cover rounded-md" />
