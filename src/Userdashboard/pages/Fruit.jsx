        ...
        <div className="p-6 h-screen">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6">
                <div className="bg-white shadow-md rounded-lg p-4 flex flex-col items-center">
                    <img src="/public/assets/Fruit Tarts.jpeg" alt="public/Burger 🍔.jpeg" className="w-48 h-48 object-cover rounded-md" />
                ...
                <div className="bg-white shadow-md rounded-lg p-4 flex flex-col items-center">
                    <img src="/public/assets/FRUIT SALAD.jpeg" alt="KFC" className="w-48 h-48 object-cover rounded-md" />
                ...
                <div className="bg-white shadow-md rounded-lg p-4 flex flex-col items-center">
                    <img src="/public/assets/fruit1.jpeg" alt="Pizza" className="w-48 h-48 object-cover rounded-md" />
